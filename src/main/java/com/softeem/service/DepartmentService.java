...
public interface DepartmentService {
     ...
     * @param department
     */
    void switchStatus(SwitchDepartmentRequestDTO department);

    /*
     * @Description 查询部门列表(过滤查询)
     * @Param [departmentListRequestDTO]
     * @return void
     */
    Map queryPageList(DepartmentListRequestDTO departmentListRequestDTO);
}